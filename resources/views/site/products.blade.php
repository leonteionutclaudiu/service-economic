            ...
            <div
                ...
                @forelse ($products as $product)
                    <div
                        ...
                        <button class="flex items-center justify-center gap-2 mb-2 p-2 rounded-md bg-economic-darkgreen w-fit mx-auto transition border border-economic-darkgreen addToCartBtn"><svg height="26px"
                ...
                @empty
                    <p class="text-center text-gray-500 col-span-full">Nu exista produse pentru aceasta categorie.</p>
                @endforelse
            </div>
