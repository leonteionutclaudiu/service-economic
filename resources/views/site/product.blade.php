            ...
            {{-- <div
                ...
                @if ($product->files->isNotEmpty())
                    <button onclick="showContent('brosuri', this)"
                        class="p-2 font-bold text-black transition duration-500 ease-in-out hover:text-economic-red tab-button inactive-button">Brosuri
                        & fise tehnice</button>
                @endif
