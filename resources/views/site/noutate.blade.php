        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-3">
            ...
            <div class="h-fit static md:sticky md:top-[100px] md:right-0">
                ...
                @foreach ($noutatiRelevante as $noutateRelevanta)
                    <a href="/articole/{{ $noutateRelevanta->slug }}" class="shadow-md flex flex-col items-center justify-center gap-2 mb-3 rounded-md p-2 transition duration-300 hover:shadow-xl">
