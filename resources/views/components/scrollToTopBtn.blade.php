<button
    class="fixed z-50 flex items-center justify-center w-8 h-8 p-2 text-white transition rounded-full shadow-md bg-stone-700 lg:w-10 lg:h-10 bottom-8 right-8 hover:bg-stone-500"
