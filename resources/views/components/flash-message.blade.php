...
<div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 7000)"
    ...
    class="animate__animated animate__bounce animate__slow fixed {{ $bottomClass }} right-0 flex items-center p-4 text-2xl md:text-3xl rounded-lg z-[999]"
    :class="{
    ...
    role="alert">
    <svg class="flex-shrink-0 inline w-4 h-4 md:w-7 md:h-7 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
