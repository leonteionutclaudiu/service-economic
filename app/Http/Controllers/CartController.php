...
class CartController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $product = $cartItem->product;
        // Verificați dacă cantitatea a devenit zero și eliminați produsul din coș
        if ($product->stock_quantity == 0) {
            $cartItem->delete();

            return redirect('/cart')->with('success', 'Produsul a fost eliminat din coș deoarece nu mai este pe stoc in acest moment.');
        }
